...
- **操作系统**：Windows 10 1809（10.0.17763）及以上，建议 Windows 11
- **运行内存**：建议 16GB 及以上
- **显示加速卡**：建议搭载 NVIDIA GeForce RTX 2060 及以上的显示加速卡，更新到最新的驱动以支持画面AI超分与HDR
- **架构**：x64
- **运行时**：.NET 10（安装包通常已内置或自动引导）
- **管理员权限**：安装时因为要创建 TAP/Wintun 虚拟网卡需要管理员权限，软件正常运行无需管理员权限
